...
public class UsuarioPanel extends JPanel {
	...
	public UsuarioPanel() {
		...
		modeloUsuario.setColumnIdentifiers(new Object[] { "ID", "Nombre", "Teléfono", "Email",
				"Calle", "Código postal", "DNI", "Tipo de perfil", "Contraseña" });
		...
		comboBoxPerfil = new JComboBox(Perfiles);
